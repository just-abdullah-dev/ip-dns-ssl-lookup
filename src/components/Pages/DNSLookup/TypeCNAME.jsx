...
export default function TypeCNAME({ domain }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-bold text-3xl">CNAME Records</CardTitle>
        <CardDescription>
      ...
      <CardContent>
        {data?.Answer || data?.Authority ? (
            ...
            <div className="mt-6 space-y-4 col-span-1">
              ...
              {hasAnswer ? (
                <Alert>
                  ...
                  <AlertTitle>CNAME Record</AlertTitle>
                  <AlertDescription>
                    The domain {domain} is an alias for: {data?.Answer[0].data}
                  </AlertDescription>
                </Alert>
              ) : (
                <Alert>
                  <AlertTriangle className="h-4 w-4" />
                  <AlertTitle>No CNAME Record</AlertTitle>
                  <AlertDescription>
                    No CNAME record was found for {domain}. This could mean the domain uses A records directly or there might be an issue with the DNS configuration.
                  </AlertDescription>
                </Alert>
              )}
          ...
          <Alert>
            <AlertTitle>No CNAME records found</AlertTitle>
            <AlertDescription>
              This domain does not have any CNAME records or they are not publicly
              accessible.
            </AlertDescription>
          </Alert>
        )}
