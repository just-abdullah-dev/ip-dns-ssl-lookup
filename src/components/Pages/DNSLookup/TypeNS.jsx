...
export default function TypeNS({ domain }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-bold text-3xl">NS Records</CardTitle>
        <CardDescription>
      ...
      <CardContent>
        {data?.Answer ? (
            ...
            <div className="mt-6 space-y-4 col-span-1">
              ...
              {hasAnswer ? (
                <>
                  <Alert>
                    ...
                    <AlertTitle>NS Records</AlertTitle>
                    <AlertDescription>
                      The domain {domain} has the following name servers:
                  ...
                  <Alert>
                    <Info className="h-4 w-4" />
                    <AlertTitle>NS Record Analysis</AlertTitle>
                    <AlertDescription>
                      <ul className="list-disc list-inside mt-2">
                        <li>NS records specify the authoritative name servers for this domain.</li>
                        <li>These servers are responsible for answering queries about the domain and its subdomains.</li>
                        <li>Having multiple name servers provides redundancy and improves reliability.</li>
                      </ul>
                    </AlertDescription>
                  </Alert>
                </>
                ...
                <Alert>
                  ...
                  <AlertTitle>No NS Records</AlertTitle>
                  <AlertDescription>
                    No NS records were found for {domain}. This is unusual and might indicate a problem with the domain's DNS configuration.
                  </AlertDescription>
                </Alert>
              )}
              ...
              {hasAnswer && (
                <Alert>
                  ...
                  <AlertDescription>
                    The TTL for these NS records is {data.Answer[0].TTL} seconds (
          ...
          <Alert>
            <AlertTitle>No NS records found</AlertTitle>
            <AlertDescription>
              This domain does not have any NS records or they are not publicly
