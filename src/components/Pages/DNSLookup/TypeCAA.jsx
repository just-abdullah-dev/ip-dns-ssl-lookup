...
export default function TypeCAA({ domain }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-bold text-3xl">CAA Records</CardTitle>
        <CardDescription>
      ...
      <CardContent>
        {data?.Answer ? (
            ...
            <div className="mt-6 space-y-4 col-span-1">
              ...
              {hasAnswer ? (
                <>
                  <Alert>
                    ...
                    <AlertTitle>CAA Records</AlertTitle>
                    <AlertDescription>
                      The domain {domain} has the following CAA records:
                      <ul className="list-disc list-inside mt-2">
                        {data.Answer.map((a, index) => {
                          const [flag, tag, value] = a.data.split(' ');
                          return (
                            <li key={index}>
                              Flag: {flag}, Tag: {tag}, Value: {value.replace(/"/g, '')}
                            </li>
                          );
                        })}
                      </ul>
                  ...
                  <Alert>
                    <Info className="h-4 w-4" />
                    <AlertTitle>CAA Record Analysis</AlertTitle>
                    <AlertDescription>
                      <ul className="list-disc list-inside mt-2">
                        <li>Issue records: Specify which CAs are allowed to issue certificates for this domain.</li>
                        <li>Issuewild records: Specify which CAs are allowed to issue wildcard certificates for this domain.</li>
                        <li>The flag value of 0 indicates that the CA must understand and obey the record.</li>
                      </ul>
                    </AlertDescription>
                  </Alert>
                </>
                ...
                <Alert>
                  ...
                  <AlertTitle>No CAA Records</AlertTitle>
                  <AlertDescription>
                    No CAA records were found for {domain}. This means any Certificate Authority can issue SSL/TLS certificates for this domain.
                  </AlertDescription>
                </Alert>
              )}
              ...
              {hasAnswer && (
                <Alert>
                  ...
                  <AlertDescription>
                    The TTL for these CAA records is {data.Answer[0].TTL} seconds (
          ...
          <Alert>
            <AlertTitle>No CAA records found</AlertTitle>
            <AlertDescription>
              This domain does not have any CAA records or they are not publicly
              accessible. This means any Certificate Authority can issue SSL/TLS certificates for this domain.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
